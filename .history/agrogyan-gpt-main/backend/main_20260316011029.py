...
def get_posts(limit: int = 6, offset: int = 0, search: str = ""):
    ...
    for p in posts:
            jile "C:\Users\sanja\OneDrive\Desktop\agrogyan-gpt-main\venv\Lib\site-packages\anyio\_backends\_asyncio.py", line 986, in run
    result = context.run(func, *args)
  File "C:\Users\sanja\OneDrive\Desktop\agrogyan-gpt-main\agrogyan-gpt-main\backend\main.py", line 222, in get_posts
